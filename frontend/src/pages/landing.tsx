...
const plans = [
  {
    ...
    features: ["1 domain", "50 mailboxes", "500 MB / mailbox", "500 emails / day", "Webmail access"],
    cta: "Get Started",
    popular: false,
  },
  {
    ...
    price: "$29.99",
    period: "/ month",
    features: ["5 domains", "200 mailboxes", "2 GB / mailbox", "2,000 emails / day", "Priority support", "IMAP/SMTP access"],
  ...
  },
  {
    ...
    price: "Custom",
    period: "contact us",
    features: ["Unlimited domains", "Unlimited mailboxes", "Custom storage", "Unlimited sending", "Dedicated IP", "SLA guarantee"],
    cta: "Contact Sales",
    popular: false,
  },
];
